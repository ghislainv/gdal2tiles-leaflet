...
gdaldem color-relief data/forest_jrc_NCL.tif fcc_color_file.txt data/fcc_RGB_newcal.tif -alpha -co "COMPRESS=DEFLATE" -co "PREDICTOR=2" -co "ZLEVEL=9"
...
#===== With gdal_retile for Geoserver
inputFile="data/forest_NCL.tif"
targetDir="/home/geoserver/data_dir/data/far/newcal/pyramid_forest_NCL"
sudo -u geoserver gdal_retile.py -useDirForEachRow -r near -levels 4 -ps 2048 2048 -co "TILED=YES" -targetDir $targetDir $inputFile
