...
gdalwarp -s_srs EPSG:3163 -t_srs EPSG:3857 -r near -co "COMPRESS=DEFLATE" -co "PREDICTOR=2" -co "ZLEVEL=9" data/fcc_RGB_newcal.tif data/fcc_RGB_newcal_mercator.tif 
gdal_translate -co "RESAMPLING=NEAREST" data/fcc_RGB_newcal_mercator.tif data/fcc_newcal.mbtiles
